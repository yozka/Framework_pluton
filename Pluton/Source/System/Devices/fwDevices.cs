...
namespace Pluton.SystemProgram.Devices
{
    ...
    public class ADevices
    {
        ...
        public void loadSettings()
        {
            ...
            license.loadSettings(storage);
            social.loadSettings(storage);
        }
        ///--------------------------------------------------------------------------------------
        ...
        {
            social.saveSettings(storage);
            license.saveSettings(storage);
        ...
        ///
        /// <summary>
        /// игра поодерживает выход из игры
        /// </summary>
        /// 
        ///--------------------------------------------------------------------------------------
        public bool isExitGame()
        {
            return input.isExitGame();
        }
        ///--------------------------------------------------------------------------------------
        ...
        {
            input.exitGame(m_screenManager.Game);
            mExitGame = true;
        }
        ///--------------------------------------------------------------------------------------
