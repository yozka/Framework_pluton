...
namespace Pluton.GUI
{
    ...
    public class AWidget
    {
        ...
        ///
        /// <summary>
        /// начало контента слева
        /// в экранных координатах
        /// </summary>
        /// 
        ///--------------------------------------------------------------------------------------
        public int screenContentLeft
        {
            get
            {
                return parentLeft + m_left + m_marginLeft;
            }
        }
        ///--------------------------------------------------------------------------------------
        ...
        ///
        /// <summary>
        /// начало контента сверху
        /// в экранных координатах
        /// </summary>
        /// 
        ///--------------------------------------------------------------------------------------
        public int screenContentTop
        {
            get
            {
                return parentTop + m_top + m_marginTop;
            }
        }
        ///--------------------------------------------------------------------------------------
        ...
        ///
        /// <summary>
        /// задать высоту виджета
        /// </summary>
        /// 
        ///--------------------------------------------------------------------------------------
        public AWidget setHeight(int value)
        {
            height = value;
            return this;
        }
        ...
        /// 
        ///--------------------------------------------------------------------------------------
        public AWidget setPosition(Point ptLeftTop)
        {
            m_left = ptLeftTop.X;
            m_top = ptLeftTop.Y;
            resize(true, true, false, false);
