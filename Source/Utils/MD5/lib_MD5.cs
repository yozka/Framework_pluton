...
#pragma warning disable 1591
    ...
    public static class libMD5
    {
        ...
        public static byte[] GetHash(byte[] input)
        {
            ...
            {
                libMD5.GetHashBlock(input, ref abcd, startIndex);
                startIndex += 64;
            }
            // The final data block. 
            return libMD5.GetHashFinalBlock(input, startIndex, input.Length - startIndex, abcd, (Int64)input.Length * 8);
        }
